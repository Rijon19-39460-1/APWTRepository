		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					...
					<div class="img" style="background-image: url(../image/rideShare.jpg); background-repeat: no-repeat; background-size: contain;">
			      	...
			      	<div class="d-flex">
                        ...
                        <!--
							...
							<form action="{{route('adminLoginSubmit')}}" class="signin-form" method="post" name="form" onsubmit="return valid();">
                            {{csrf_field()}}
                            @if ($errors->any())
		          ...
		          <p class="text-center">Not a member? <a data-toggle="tab" href="{{route('adminRegistration')}}">Sign Up</a></p>
		        </div>
		      </div>
				</div>
			</div>
